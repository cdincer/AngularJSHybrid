...
/* /common/init.js*/
/**
 * @preserve Basic Primitives Diagram v3.7.10
				...
				if (showCallout) {
					...
					_transform.transformRect(actualPosition.x, actualPosition.y, actualPosition.width, actualPosition.height, true,
						this, function (x, y, width, height) {
							...
							if ((treeItemPosition.actualVisibility >= _options.calloutMaximumVisibility && treeItemPosition.actualVisibility != 4/*primitives.common.Visibility.Invisible*/)
								|| !panelPosition.overlaps(snapRect)) {
